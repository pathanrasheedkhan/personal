// EceQuestionPapers.jsx

import React from "react";
import eceQuestionPaperData from "../Data/ecequestion.js";

const EceQuestionPapers = () => {
  return (
    <div className="min-h-screen  p-8">
      <h2 className="text-4xl font-bold text-center text-purple-900 mb-10 drop-shadow">
        ECE Question Papers
      </h2>

      {eceQuestionPaperData.map((yearBlock, index) => (
...
export default EceQuestionPapers;
